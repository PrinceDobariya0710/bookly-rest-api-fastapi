...
from src.constants import ADMIN_ROLE, ALLOWED_ROLES
...
admin_role_checker = Depends(RoleChecker([ADMIN_ROLE]))
user_role_checker = Depends(RoleChecker(ALLOWED_ROLES))
